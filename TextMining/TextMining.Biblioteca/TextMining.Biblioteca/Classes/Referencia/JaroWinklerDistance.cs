...
namespace TextMining.Biblioteca.Classes.Referencia
{
    public class JaroWinklerDistance
    {
        ...
        public float GetDistance(String s1, String s2)
        {
            ...
            float jw = j < Limite ? j : j + Math.Min(0.1f, 1f / mtp[3]) * mtp[2] * (1 - j);
            return jw;
        }

        /// <summary>
        /// Gets or sets the current value of the Limite used for adding the Winkler bonus.
