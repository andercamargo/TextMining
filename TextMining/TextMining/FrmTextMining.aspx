<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTextMining.aspx.cs" Inherits="TextMining.frmTextMining" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .modal {
            ...
            height: 100%;
            width: 100%;
            background: #E6E6E6 url('images/gifProcessando.gif') 50% 50% no-repeat;
        }
    ...
    <script type="text/javascript">
        ...
        var codTextMining = "";
        var tarefas = "";
        var urlTextMining = "FrmTextMining.aspx/";
        ...
        $(function () {
            ...
            $("#btnGravar").click(function analisarTextMining() {
